...
export default async function InventoryItemPage({ params }: { params: { itemId: string } }) {
  ...
  if (!item) {
    return <div className="container mx-auto py-6 text-center text-destructive">Item not found.</div>;
  }
         ...
         <div className="grid md:grid-cols-3 gap-0">
           ...
           <div className="md:col-span-2 p-6">
             <CardHeader className="p-0 mb-4">
               ...
               <CardDescription className="text-lg text-muted-foreground">{item.style} / {item.material}</CardDescription>
             </CardHeader>
             ...
             <CardContent className="p-0 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                   ...
                   <div><span className="font-medium text-muted-foreground">Weight:</span> {item.weight}</div>
                   <div><span className="font-medium text-muted-foreground">Lead Time:</span> {item.leadTime}</div>
                    <div>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                   <div>
                    ...
                    <div>
                     ...
                     {item.relatedShipments.length > 0 ? (
                       <ul className="space-y-1 text-sm">
