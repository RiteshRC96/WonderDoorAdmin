...
export const AddItemSchema = z.object({
  ...
  // imageUrl is now optional and can be an empty string.
  // The actual URL will be generated by the server action after upload.
  imageUrl: z.string().url("Must be a valid URL (will be set after upload)").optional().or(z.literal('')),
...
export interface AddItemPayload extends AddItemInput {
  imageDataUrl?: string; // Optional Data URL string for the image
}
